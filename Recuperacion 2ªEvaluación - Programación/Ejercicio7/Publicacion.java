...
public abstract class Publicacion extends ObjetoInventario{
    ...
    public Publicacion(String fechaCompra, int codigo, String titulo, int anioPublicacion) {
        super(fechaCompra);
        this.codigo = codigo;
        this.titulo = titulo;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), codigo, titulo, anioPublicacion);
    }
